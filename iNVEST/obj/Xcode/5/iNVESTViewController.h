...
@property (retain, nonatomic) IBOutlet UITextField *txtPapel;
@property (retain, nonatomic) IBOutlet UITextField *txtQuantidade;
@property (retain, nonatomic) IBOutlet UITextField *txtValor;
